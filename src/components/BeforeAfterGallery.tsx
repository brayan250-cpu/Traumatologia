...
export function BeforeAfterGallery() {
  ...
  return (
    <section id="casos" style={{ background: 'rgba(7,11,24,.82)', padding: 'clamp(72px,9vw,120px) 0' }}>
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mx-auto mb-11" style={{ maxWidth: '640px' }}>
          <div className="inline-flex items-center gap-3 font-mono-mc font-medium uppercase mb-4" style={{ fontSize: '12px', letterSpacing: '.2em', color: '#93C5FD' }}>
            <span style={{ width: '22px', height: '1px', background: '#14B8A6' }} />
            03 · Casos de éxito
          </div>
          <h2 className="font-extrabold mb-4" style={{ fontSize: 'clamp(30px,4.2vw,46px)', letterSpacing: '-.01em', lineHeight: '1.04', color: '#fff', margin: '16px 0 14px' }}>
            Resultados reales
          </h2>
...
loading="lazy" 
            ...
            <button
              ...
              style={{ background: 'rgba(30, 30, 30, 0.85)', border: '1px solid rgba(255,255,255,.18)', color: '#fff' }}
            >
              <ArrowLeftRight className="w-5 h-5" style={{ color: '#60A5FA' }} />
          ...
          <div className="rounded-2xl p-6 sm:p-8 space-y-6" style={{ background: 'rgba(255,255,255,.05)', border: '1px solid rgba(255,255,255,.1)' }}>
            ...
            <div className="flex items-center gap-3 rounded-xl p-4" style={{ background: 'rgba(15,200,100,.12)', border: '1px solid rgba(15,200,100,.22)' }}>
              ...
              <div>
                <p className="text-sm font-medium" style={{ color: '#14B8A6' }}>Resultado</p>
